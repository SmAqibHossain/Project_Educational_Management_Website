...
<body>
    ...
    <div class="image-container">
        <img src="20231208_104220-min.jpg" alt="Your image">
        <div class="overlay">
            <div class="tagline">
                <p>Welcome to IUB Tech 360</p>
            </div>
    ...
    <div class="empowering-container">
        <div class="empowering-img">
            <img src="20231208_104220-min.jpg" alt="">
        </div>
    ...
    <div class="contact-us-container">
        ...
        <div class="contact-us-info">
            ...
            <div class="details">
                <div class="email">
                    <h3>Email</h3>
                    <a href="2120757@iub.edu.bd">2120757@iub.edu.bd</a>
                </div>
                <div class="phone">
                    <h3>Phone</h3>
                    <p>01894749253</p>
                ...
                <div class="office">
                    <h3>Office</h3>
                    <p>32/A, Road B, Bashundhara R/A </p>
                </div>
            </div>
        </div>
    </div>
